...
useEffect (() => {
  const characters = async () => {
    try {
      setLoading (true)
      const response = await fetch ('https://rickandmortyapi.com/api/character') // realiza la petición a la api
...
if (error) return <h1>Error en la película de los personajes</h1>
  return (
    <>
      {
